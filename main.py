...
def saveInstructions():
    ...
    user_name.instructionData = instructionData

    print(instructions)
    print(instructionData)
    db.session.commit()
    return {"msg":"Successfully Saved","instructions" : instructions, "instructionData" : instructionData}
...
def getData():
    ...
    return jsonify({
        ...
        "chatData": chat_log,
        "instructionData": instructions.instructionData,
        "image": file_url,
        "pdf": pdf_url
    })
